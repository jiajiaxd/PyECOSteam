...
class ECOsteamClient:
    # https://s.apifox.cn/8dd30eef-e628-4390-b503-846412c608ee/ 查看API文档
    def __init__(self, partnerId, RSAKey) -> None:
        self.logger = logger
    ...
    def post(self, api: str, data: dict):
        ...
        resp = requests.post(
            ...
            headers={"User-Agent": "Steamauto Private", "Content-Type": "application/json"},
        )
        data["Sign"] = "******"
